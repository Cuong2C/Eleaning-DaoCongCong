    ...
    if (_.isEmpty(userSignIn)) {
      return (
        <div className="flex ml-auto">
          ...
          <Link
            className="active w-max text-center font-normal hover:shadow-xl lg:text-md xl:text-lg sm:px-4 sm:py-2 p-3 text-xs rounded-md bg-main-500 text-white hover:text-white"
            to="/signup"
          >
            {t("Đăng ký")}
          </Link>
